		...
		switch (_phase)
			...
			case 1:
				...
				if (attack_frame <= 20 && attack_frame > 8)
					{
						...
						var _hitbox = hitbox_create_magnetbox(1, 14, 0.2, 0.5, 1, 3, 0, 45, 30, 3, SHAPE.circle, 1);
				...
				if (attack_frame == 8)
					{
						{
						var _hitbox = hitbox_create_melee(1, 14, 0.2, 0.5, 4, 7, 0.5, 10, 45, 3, SHAPE.circle, 2);
