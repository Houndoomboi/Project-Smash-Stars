...
function character_mortis_init()
	{
	...
	if (_set_properties)
		...
		//Hurtbox
		hurtbox_sprite = spr_colt_hurtbox;
	...
	if (_set_sprites)
		...
		my_sprites[$ "Entrance"			] = anim_define(spr_mortis_idle, anim_define(spr_mortis_idle));
		my_sprites[$ "Idle"				] = spr_mortis_idle;
		my_sprites[$ "Crouch"			] = anim_define(spr_mortis_crouch, anim_define(spr_mortis_crouchloop));
		my_sprites[$ "Walk"				] = spr_mortis_run;
		my_sprites[$ "Walk_Turn"		] = spr_mortis_run;
		my_sprites[$ "Dash"				] = spr_mortis_run;
		my_sprites[$ "Run"				] = spr_mortis_run;
		my_sprites[$ "Run_Turn"			] = spr_mortis_run;
		my_sprites[$ "Run_Stop"			] = spr_mortis_run;
				 
		my_sprites[$ "Jumpsquat"		] = spr_mortis_crouch;
		my_sprites[$ "Jump_Rise"		] = spr_mortis_jump;
		my_sprites[$ "Jump_Mid"			] = spr_mortis_fall;
		my_sprites[$ "Jump_Fall"		] = spr_mortis_fall;
		my_sprites[$ "Fastfall"			] = spr_mortis_fall;
		my_sprites[$ "DJump_Rise"		] = anim_define(spr_mortis_jump, anim_define(spr_mortis_jump));
		my_sprites[$ "DJump_Mid"		] = -1;
		my_sprites[$ "DJump_Fall"		] = -1;
		my_sprites[$ "DFastfall"		] = -1;
				 
		my_sprites[$ "Airdodge"			] = anim_define_ext(spr_mortis_airdodge, 0, anim_calculate_speed(spr_mortis_airdodge, airdodge_startup + airdodge_active + airdodge_endlag));
		my_sprites[$ "Waveland"			] = spr_mortis_crouch;
		my_sprites[$ "Rolling"			] = spr_mortis_airdodge;
		my_sprites[$ "Shield"			] = anim_define(spr_mortis_shield_begin, anim_define(spr_mortis_shield));
		my_sprites[$ "Shield_Release"	] = spr_mortis_idle;
		...
		my_sprites[$ "Spot_Dodge"		] = spr_mortis_airdodge;
		my_sprites[$ "Bury"				] = spr_colt_bury;
				 
		my_sprites[$ "Hitlag"			] = spr_mortis_hurt;
		my_sprites[$ "Hitstun"			] = spr_mortis_hurt;
		my_sprites[$ "Tumble"			] = spr_mortis_hurt;
		my_sprites[$ "Helpless"			] = spr_mortis_jump;
		my_sprites[$ "Magnet"			] = spr_mortis_hurt;
		my_sprites[$ "Flinch"			] = spr_mortis_hurt;
		...
		my_sprites[$ "Teching_Wall"		] = spr_mortis_jump;
		my_sprites[$ "Teching_Ceiling"	] = spr_mortis_jump;
		my_sprites[$ "Tech_Wall_Jump"	] = spr_mortis_jump;
				 
		my_sprites[$ "Ledge_Snap"		] = spr_mortis_ledge;
		my_sprites[$ "Ledge_Hang"		] = spr_mortis_ledge;
		my_sprites[$ "Ledge_Getup"		] = spr_mortis_crouchloop;
		my_sprites[$ "Ledge_Jump"		] = spr_mortis_jump;
		my_sprites[$ "Ledge_Roll"		] = spr_mortis_airdodge;
		...
		my_sprites[$ "Grab_Release"		] = anim_define(spr_mortis_crouch, anim_define(spr_mortis_crouchloop));
		}
	}
