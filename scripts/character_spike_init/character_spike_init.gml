...
function character_spike_init()
	...
	if (_set_properties)
		{
		//Collision box
		collision_box = spr_spike_collision_box;
	
		//Hurtbox
		hurtbox_sprite = spr_spike_hurtbox;
	...
	if (_set_attacks)
		{
		my_attacks[$ "Jab"			] = spike_jab;
				 
		my_attacks[$ "Fsmash"		] = spike_strong;
				 
		my_attacks[$ "Nair"			] = spike_airlight;
		my_attacks[$ "Dair"			] = spike_airstrong;
				 
		my_attacks[$ "Nspec"		] = spike_special;
		my_attacks[$ "Uspec"		] = spike_airspecial;
				 
		my_attacks[$ "Grab"			] = spike_grab;
		my_attacks[$ "Dash_Grab"	] = spike_grab;
	...
	if (_set_sprites)
		...
		my_sprites[$ "Jump_Mid"			] = spr_spike_jump_mid;
		my_sprites[$ "Jump_Fall"		] = anim_define(spr_spike_airdodge, anim_define(spr_spike_fall));
		my_sprites[$ "Fastfall"			] = spr_spike_fall;
		my_sprites[$ "DJump_Rise"		] = anim_define(spr_spike_jump, anim_define(spr_spike_jump_mid));
		my_sprites[$ "DJump_Mid"		] = spr_spike_jump_mid;
		my_sprites[$ "DJump_Fall"		] = anim_define(spr_spike_airdodge, anim_define(spr_spike_fall));
		...
		my_sprites[$ "Balloon"			] = spr_spike_hurt;
		my_sprites[$ "Reeling"			] = spr_spike_hurt;
		...
		my_sprites[$ "Grabbed"			] = spr_spike_hurt;
		my_sprites[$ "Grab_Release"		] = anim_define(spr_spike_crouch, anim_define(spr_spike_crouch_loop));
		}
	}
