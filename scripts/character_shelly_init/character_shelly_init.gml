...
function character_shelly_init()
	{
	...
	if (_set_properties)
		...
		//Hurtbox
		hurtbox_sprite = spr_shelly_hurtbox;
	...
	if (_set_attacks)
		{
		my_attacks[$ "Jab"			] = shelly_jab;
				 
		my_attacks[$ "Fsmash"		] = shelly_strong;
				 
		my_attacks[$ "Nair"			] = shelly_airlight;
		my_attacks[$ "Dair"			] = shelly_airstrong;
	...
	if (_set_sprites)
		...
		my_sprites[$ "Walk_Turn"		] = spr_shelly_run;
		my_sprites[$ "Dash"				] = spr_shelly_run;
		my_sprites[$ "Run"				] = spr_shelly_run;
		my_sprites[$ "Run_Turn"			] = spr_shelly_run;
		my_sprites[$ "Run_Stop"			] = spr_shelly_run;
				 
		my_sprites[$ "Jumpsquat"		] = spr_basic_jumpsquat;
		my_sprites[$ "Jump_Rise"		] = spr_shelly_jump;
		my_sprites[$ "Jump_Mid"			] = spr_shelly_jump;
		my_sprites[$ "Jump_Fall"		] = spr_shelly_fall;
		my_sprites[$ "Fastfall"			] = spr_shelly_fall;
		my_sprites[$ "DJump_Rise"		] = anim_define(spr_shelly_jump, anim_define(spr_shelly_fall));
		...
		my_sprites[$ "Tumble"			] = spr_shelly_hit;
		my_sprites[$ "Helpless"			] = spr_shelly_fall;
		...
		my_sprites[$ "Ledge_Hang"		] = spr_shelly_ledge;
		my_sprites[$ "Ledge_Getup"		] = spr_shelly_idle;
		my_sprites[$ "Ledge_Jump"		] = spr_shelly_jump;
