...
function character_nita_init()
	...
	if (_set_sprites)
		...
		my_sprites[$ "Entrance"			] = anim_define(spr_nita_idle, anim_define(spr_nita_idle));
		my_sprites[$ "Idle"				] = spr_nita_idle;
		my_sprites[$ "Crouch"			] = anim_define(spr_nita_crouch, anim_define(spr_nita_crouch_loop));
		my_sprites[$ "Walk"				] = spr_nita_run;
		my_sprites[$ "Walk_Turn"		] = spr_nita_run;
		my_sprites[$ "Dash"				] = spr_nita_run;
		my_sprites[$ "Run"				] = spr_nita_run;
		my_sprites[$ "Run_Turn"			] = spr_nita_run;
		my_sprites[$ "Run_Stop"			] = spr_nita_run;
		...
		my_sprites[$ "Airdodge"			] = anim_define_ext(spr_nita_airdodge, 0, anim_calculate_speed(spr_nita_airdodge, airdodge_startup + airdodge_active + airdodge_endlag));
		my_sprites[$ "Waveland"			] = spr_nita_crouch;
		my_sprites[$ "Rolling"			] = spr_nita_airdodge;
		my_sprites[$ "Shield"			] = anim_define(spr_nita_shield_begin, anim_define(spr_nita_shield));
		my_sprites[$ "Shield_Release"	] = spr_nita_idle;
		...
		my_sprites[$ "Spot_Dodge"		] = spr_nita_airdodge;
		my_sprites[$ "Bury"				] = spr_colt_bury;
				 
		my_sprites[$ "Hitlag"			] = spr_nita_hurt;
		my_sprites[$ "Hitstun"			] = spr_nita_hurt;
		my_sprites[$ "Tumble"			] = spr_nita_hurt;
		my_sprites[$ "Helpless"			] = spr_nita_jump;
		my_sprites[$ "Magnet"			] = spr_nita_hurt;
		my_sprites[$ "Flinch"			] = spr_nita_hurt;
		my_sprites[$ "Landing_Lag"		] = anim_define(spr_nita_crouch, anim_define(spr_nita_crouch_loop));
		my_sprites[$ "Balloon"			] = spr_nita_hurt;
		my_sprites[$ "Reeling"			] = spr_nita_hurt;
		...
		my_sprites[$ "Tech_Rolling"		] = spr_nita_airdodge; 
		my_sprites[$ "Teching"			] = spr_nita_crouch_loop;
		my_sprites[$ "Teching_Wall"		] = spr_nita_jump;
		my_sprites[$ "Teching_Ceiling"	] = spr_nita_jump;
		my_sprites[$ "Tech_Wall_Jump"	] = spr_nita_jump;
				 
		my_sprites[$ "Ledge_Snap"		] = spr_nita_ledge;
		my_sprites[$ "Ledge_Hang"		] = spr_nita_ledge;
		my_sprites[$ "Ledge_Getup"		] = spr_nita_crouch_loop;
		my_sprites[$ "Ledge_Jump"		] = spr_nita_jump;
		my_sprites[$ "Ledge_Roll"		] = spr_nita_airdodge;
		...
		my_sprites[$ "Grab_Release"		] = anim_define(spr_nita_crouch, anim_define(spr_nita_crouch_loop));
		}
	}
